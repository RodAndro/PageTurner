                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        @if(Auth::user()->is_admin)
                            <x-dropdown-link :href="route('admin_home')">
                                {{ __('Admin Homepage') }}
                            </x-dropdown-link>
                        ...
                        @else
                            ...
                            <x-dropdown-link :href="route('purchased-books.show')">
                                {{ __('Purchased Books') }}
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                @if(Auth::user()->is_admin)
                    <x-responsive-nav-link :href="route('admin_home')">
                        {{ __('Admin Homepage') }}
                ...
                @else
                    ...
                    <x-responsive-nav-link :href="route('orders.show')">
                        {{ __('Orders') }}
                    </x-responsive-nav-link>

                    <x-responsive-nav-link :href="route('purchased-books.show')">
                        {{ __('Purchased Books') }}
                    </x-responsive-nav-link>
