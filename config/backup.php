...
return [
    ...
    'backup' => [
        ...
        'retention' => [
            ...
            'max_backups' => env('BACKUP_MAX_COUNT', 100),
        ...
        'notifications' => [
            ...
            'channels' => [
                ...
                'slack' => env('BACKUP_SLACK_NOTIFICATIONS', false),
            ],
            'events' => [
                'success' => ['admin', 'devops'],
                'failure' => ['admin', 'devops', 'support'],
            ],
        ],
         ...
         */
        'performance' => [
            'max_execution_time' => env('BACKUP_MAX_EXECUTION_TIME', 3600), // 1 hour
            'memory_limit_mb' => env('BACKUP_MEMORY_LIMIT_MB', 512),
            'chunk_size' => env('BACKUP_CHUNK_SIZE', 1000),
            'parallel_jobs' => env('BACKUP_PARALLEL_JOBS', 2),
        ],
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => 'pageturner-backup-',

            /*
             * The disk names on which the backups will be stored.
             * Local disk for encrypted local backups, s3 for cloud storage
             */
            'disks' => [
                'local',
                's3',
         ...
         */
        'password' => env('BACKUP_ARCHIVE_PASSWORD', 'default-backup-password'),
    ...
    'notifications' => [
        ...
        'mail' => [
            ...
            'from' => [
                ...
                'name' => env('MAIL_FROM_NAME', 'PageTurner'),
            ],
        ],
    ...
    'monitor_backups' => [
        [
            ...
            'health_checks' => [
                ...
                \Spatie\Backup\Tasks\Monitor\HealthChecks\MaximumStorageInMegabytes::class => 51200,
            ],
        ],
    ],
